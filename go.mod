...
require (
	...
	github.com/redhat-cne/ptp-listener-lib v0.1.6 // indirect
...
replace (
	...
	github.com/openshift/ptp-operator => github.com/openshift/ptp-operator v0.0.0-20230331162429-c39ca361a8a4 // release-4.14
)
